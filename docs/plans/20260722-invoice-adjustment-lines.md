...
- [x] секція «Коригування»: додати/редагувати/видалити рядок (мітка, знакова
  сума), відображення в тоталах (окремий рядок «Коригування» + оновлений
  «Разом»)
- [x] галочка «оплата за рахунок орендаря → врахувати як витрату» (лише для
  від'ємної суми) + вибір категорії
- [x] стани/валідація за наявними патернами; лише для draft
- [x] write tests: додавання/редагування/видалення; галочка+категорія;
