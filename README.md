...
До активного контракту можна завантажити кілька приватних вкладень у форматах JPEG,
PNG, WebP або PDF розміром до 10 МБ кожне, переглянути чи видалити їх після входу.
Метадані файлів зберігаються у SQLite, а самі файли — у `data/uploads`; для повного
резервного копіювання потрібен увесь каталог `data/`.
