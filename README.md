...
період існує, нагадування припиняються.

Сповіщення можна надсилати через Telegram, email і Web Push. Push вмикається для
поточного пристрою в налаштуваннях; у production він потребує HTTPS, а на iOS —
встановленої на початковий екран PWA. Деталі production-налаштування наведені в
